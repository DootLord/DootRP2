...
RegisterNetEvent('police:server:CuffPlayer', function(playerId, isSoftcuff)
    ...
    TriggerClientEvent('QBCore:Notify', src, "attempt cuff", 'success')
    print()
    if not Player or not CuffedPlayer or not Player.Functions.GetItemByName("handcuffs") then TriggerClientEvent('QBCore:Notify', src, "failed cuff", 'success') return end
